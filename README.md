...
As informações são então armazenadas em um banco de dados Oracle (com perspectiva de futura atualização utilizando PL/SQL). Além disso, o sistema envia automaticamente um e-mail para meu endereço pessoal, contendo todas as informações fornecidas pelo cliente, bem como a descrição do pedido.
...
https://www.linkedin.com/in/iuri-%C3%A1vila-guerra-25b038259/
